...
public class CalcularImposto {
	...
	private static void calcularImpostoRenda(Funcionario fc) {
		...
		} else if (fc.getSalarioBruto() <= 2826.65) {

			fc.setDescontoIR((fc.getSalarioBruto() * 0.075) - 142.80);

		} else if (fc.getSalarioBruto() <= 3751.05) {

			fc.setDescontoIR((fc.getSalarioBruto() * 0.15) - 354.80);

		} else if (fc.getSalarioBruto() <= 4664.68) {

			fc.setDescontoIR((fc.getSalarioBruto() * 0.225) - 636.13);

		} else {
			fc.setDescontoIR((fc.getSalarioBruto() * 0.275) - 869.36);
		}
	}
